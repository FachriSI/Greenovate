    ...
    <div className="h-screen flex flex-row">
      ...
      <div className="flex flex-col justify-center w-full lg:w-1/2 bg-white px-8 py-12 lg:px-14 lg:py-10">
        ...
        <form className="w-full flex flex-col gap-6">
          <div>
            <label htmlFor="fullName" style={{ color: '#000', fontFamily: 'Montserrat', fontWeight: 500, fontStyle: 'normal', lineHeight: 'normal', marginBottom: '0.5rem', display: 'block', fontSize: '1rem' }}>Full Name</label>
            <input 
              type="text" 
              id="fullName" 
        ...
        <div className="mt-6 text-center text-sm" style={{ fontFamily: 'Montserrat', fontWeight: 500, fontStyle: 'normal', lineHeight: 'normal', color: '#000' }}>
          ...
          <Link to="/login" className="font-medium hover:underline" style={{ color: "#607C3C", fontFamily: 'Montserrat', fontWeight: 500, fontStyle: 'normal', lineHeight: 'normal' }}>
            Login here
          </Link>
        </div>
      </div>
